...
URGENCY_PATTERNS = [
    ...
    r"security (alert|breach|compromise)",
    r"mfa.*(disabled|bypass|reset)",
    r"2fa.*(required|update)",
    r"login.*attempt",
]
...
CREDENTIAL_PATTERNS = [
    ...
    r"identity (verification|check)",
    r"security (code|token|key)",
    r"backup.*(codes|phrase)",
]
...
BRAND_IMPERSONATION = [
    ...
    "coinbase", "binance", "metamask", "crypto", "dhl", "fedex", "ups",
    "irs", "hmrc", "income tax", "twitter", "x.com", "at&t", "verizon",
    "t-mobile", "fidelity", "vanguard", "schwab", "stripe",
]
